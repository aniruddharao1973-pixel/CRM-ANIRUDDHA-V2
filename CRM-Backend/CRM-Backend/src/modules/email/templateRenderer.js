...
//   /*
//   =====================================================
//   STEP 4 — Preserve Line Breaks (Only if plain text)
//   =====================================================
//   */

//   // if (!html.includes("<p") && !html.includes("<div") && !html.includes("<table")) {
//   //   html = html.replace(/\n/g, "<br/>");
//   // }
...
//             style="background:#ffffff;border-radius:8px;padding:40px;text-align:left;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
